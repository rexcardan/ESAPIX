...
namespace ESAPIX.Extensions
{
    ...
    {
        /// <summary>
        /// This method exists to guess the prescription of a plan sum by summing all plan setup prescribed doses and generating a
        ...
        /// <returns></returns>
        public static DVHPoint[] GetRelativeDVHCumulativeData(this PlanSum ps, Structure s, VolumePresentation vPres, double binWidth)
        {
