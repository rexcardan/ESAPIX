...
namespace ESAPIX.Facade.API
{
    public class Course : ESAPIX.Facade.API.ApiDataObject, System.Xml.Serialization.IXmlSerializable
    {
        ...
        public IEnumerable<ESAPIX.Facade.API.TreatmentPhase> TreatmentPhases
        {
            get
            {
                if (_client is ExpandoObject)
                {
                    if ((_client as ExpandoObject).HasProperty("TreatmentPhases"))
                    {
                        foreach (var item in _client.TreatmentPhases)
                        {
                            yield return item;
                        }
                    }
                ...
                else
                {
                    ...
                    XC.Instance.Invoke(() =>
                    {
                        var asEnum = (IEnumerable)_client.TreatmentPhases;
                        if ((asEnum) != null)
                        {
                            enumerator = asEnum.GetEnumerator();
                        }
                    ...
                    while (XC.Instance.GetValue<bool>(sc => enumerator.MoveNext()))
                    {
                        var facade = new ESAPIX.Facade.API.TreatmentPhase();
                        XC.Instance.Invoke(() =>
                        {
                            var vms = enumerator.Current;
                            if (vms != null)
            ...
            {
                if (_client is ExpandoObject)
                    _client.TreatmentPhases = value;
            }
        }

        public IEnumerable<ESAPIX.Facade.API.TreatmentSession> TreatmentSessions
        {
            get
            {
                if (_client is ExpandoObject)
                ...
                else
                {
                    ...
                    while (XC.Instance.GetValue<bool>(sc => enumerator.MoveNext()))
                    {
                        var facade = new ESAPIX.Facade.API.TreatmentSession();
                        XC.Instance.Invoke(() =>
                        {
                            var vms = enumerator.Current;
                            if (vms != null)
