...
namespace ESAPIX.Facade.API
{
    ...
    {
        public ESAPIX.Facade.API.TradeoffExplorationContext TradeoffExplorationContext
        {
            get
            {
                if ((_client) is System.Dynamic.ExpandoObject)
                {
                    if (((ExpandoObject)(_client)).HasProperty("TradeoffExplorationContext"))
                    {
                        return _client.TradeoffExplorationContext;
                    }
                    else
                    {
                        return default (ESAPIX.Facade.API.TradeoffExplorationContext);
                    }
                }
                else if ((XC.Instance) != (null))
                {
                    ...
                    {
                        if ((_client.TradeoffExplorationContext) != (null))
                        {
                            return new ESAPIX.Facade.API.TradeoffExplorationContext(_client.TradeoffExplorationContext);
                        }
                        else
                        {
                            return null;
            ...
            set
            {
                if ((_client) is System.Dynamic.ExpandoObject)
                {
                    _client.TradeoffExplorationContext = (value);
                }
                else
                {
                }
