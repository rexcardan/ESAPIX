    ...
    public class SegmentProfile
    {
        ...
        public ESAPIX.Facade.Types.SegmentProfilePoint Item
        {
            get
            {
                ...
                var local = this;
                return X.Instance.CurrentContext.GetValue<ESAPIX.Facade.Types.SegmentProfilePoint>((sc) => { if (DefaultHelper.IsDefault(local._client.Item)) { return default(ESAPIX.Facade.Types.SegmentProfilePoint); } else { return new ESAPIX.Facade.Types.SegmentProfilePoint(local._client.Item); } });
            }
            set
            {
