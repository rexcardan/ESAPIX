    ...
    public class RadioactiveSource : ESAPIX.Facade.API.ApiDataObject
    {
        ...
        public ESAPIX.Facade.API.RadioactiveSourceModel RadioactiveSourceModel
        {
            get
            {
                ...
                var local = this;
                return X.Instance.CurrentContext.GetValue<ESAPIX.Facade.API.RadioactiveSourceModel>((sc) => { return new ESAPIX.Facade.API.RadioactiveSourceModel(local._client.RadioactiveSourceModel); });
            }
            set
            {
