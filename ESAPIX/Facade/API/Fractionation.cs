    ...
    public class Fractionation : ESAPIX.Facade.API.ApiDataObject
    {
        ...
        public ESAPIX.Facade.Types.DoseValue DosePerFractionInPrimaryRefPoint
        {
            get
            {
                ...
                var local = this;
                return X.Instance.CurrentContext.GetValue<ESAPIX.Facade.Types.DoseValue>((sc) => { return new ESAPIX.Facade.Types.DoseValue(local._client.DosePerFractionInPrimaryRefPoint); });
            }
            set
            {
        ...
        public ESAPIX.Facade.Types.DoseValue PrescribedDosePerFraction
        {
            get
            {
                ...
                var local = this;
                return X.Instance.CurrentContext.GetValue<ESAPIX.Facade.Types.DoseValue>((sc) => { return new ESAPIX.Facade.Types.DoseValue(local._client.PrescribedDosePerFraction); });
            }
            set
            {
