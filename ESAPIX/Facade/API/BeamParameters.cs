    ...
    public class BeamParameters
    {
        ...
        public ESAPIX.Facade.Types.VVector Isocenter
        {
            get
            {
                ...
                var local = this;
                return X.Instance.CurrentContext.GetValue<ESAPIX.Facade.Types.VVector>((sc) => { if (DefaultHelper.IsDefault(local._client.Isocenter)) { return default(ESAPIX.Facade.Types.VVector); } else { return new ESAPIX.Facade.Types.VVector(local._client.Isocenter); } });
            }
            set
            {
