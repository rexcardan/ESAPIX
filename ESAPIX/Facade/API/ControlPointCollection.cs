    ...
    public class ControlPointCollection : ESAPIX.Facade.API.SerializableObject
    {
        ...
        public ESAPIX.Facade.API.ControlPoint Item
        {
            get
            {
                ...
                var local = this;
                return X.Instance.CurrentContext.GetValue<ESAPIX.Facade.API.ControlPoint>((sc) => { if (DefaultHelper.IsDefault(local._client.Item)) { return default(ESAPIX.Facade.API.ControlPoint); } else { return new ESAPIX.Facade.API.ControlPoint(local._client.Item); } });
            }
            set
            {
