    ...
    public class Dose : ESAPIX.Facade.API.ApiDataObject
    {
        ...
        public ESAPIX.Facade.Types.DoseValue DoseMax3D
        {
            get
            {
                ...
                var local = this;
                return X.Instance.CurrentContext.GetValue<ESAPIX.Facade.Types.DoseValue>((sc) => { if (DefaultHelper.IsDefault(local._client.DoseMax3D)) { return default(ESAPIX.Facade.Types.DoseValue); } else { return new ESAPIX.Facade.Types.DoseValue(local._client.DoseMax3D); } });
            }
            set
            {
        ...
        public ESAPIX.Facade.Types.VVector DoseMax3DLocation
        {
            get
            {
                ...
                var local = this;
                return X.Instance.CurrentContext.GetValue<ESAPIX.Facade.Types.VVector>((sc) => { if (DefaultHelper.IsDefault(local._client.DoseMax3DLocation)) { return default(ESAPIX.Facade.Types.VVector); } else { return new ESAPIX.Facade.Types.VVector(local._client.DoseMax3DLocation); } });
            }
            set
            {
        ...
        public ESAPIX.Facade.Types.VVector Origin
        {
            get
            {
                ...
                var local = this;
                return X.Instance.CurrentContext.GetValue<ESAPIX.Facade.Types.VVector>((sc) => { if (DefaultHelper.IsDefault(local._client.Origin)) { return default(ESAPIX.Facade.Types.VVector); } else { return new ESAPIX.Facade.Types.VVector(local._client.Origin); } });
            }
            set
            {
        ...
        public ESAPIX.Facade.Types.VVector XDirection
        {
            get
            {
                ...
                var local = this;
                return X.Instance.CurrentContext.GetValue<ESAPIX.Facade.Types.VVector>((sc) => { if (DefaultHelper.IsDefault(local._client.XDirection)) { return default(ESAPIX.Facade.Types.VVector); } else { return new ESAPIX.Facade.Types.VVector(local._client.XDirection); } });
            }
            set
            {
        ...
        public ESAPIX.Facade.Types.VVector YDirection
        {
            get
            {
                ...
                var local = this;
                return X.Instance.CurrentContext.GetValue<ESAPIX.Facade.Types.VVector>((sc) => { if (DefaultHelper.IsDefault(local._client.YDirection)) { return default(ESAPIX.Facade.Types.VVector); } else { return new ESAPIX.Facade.Types.VVector(local._client.YDirection); } });
            }
            set
            {
        ...
        public ESAPIX.Facade.Types.VVector ZDirection
        {
            get
            {
                ...
                var local = this;
                return X.Instance.CurrentContext.GetValue<ESAPIX.Facade.Types.VVector>((sc) => { if (DefaultHelper.IsDefault(local._client.ZDirection)) { return default(ESAPIX.Facade.Types.VVector); } else { return new ESAPIX.Facade.Types.VVector(local._client.ZDirection); } });
            }
            set
            {
