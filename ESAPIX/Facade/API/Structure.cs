    ...
    public class Structure : ESAPIX.Facade.API.ApiDataObject
    {
        ...
        public ESAPIX.Facade.Types.VVector CenterPoint
        {
            get
            {
                ...
                var local = this;
                return X.Instance.CurrentContext.GetValue<ESAPIX.Facade.Types.VVector>((sc) => { if (DefaultHelper.IsDefault(local._client.CenterPoint)) { return default(ESAPIX.Facade.Types.VVector); } else { return new ESAPIX.Facade.Types.VVector(local._client.CenterPoint); } });
            }
            set
            {
        ...
        public ESAPIX.Facade.API.SegmentVolume SegmentVolume
        {
            get
            {
                ...
                var local = this;
                return X.Instance.CurrentContext.GetValue<ESAPIX.Facade.API.SegmentVolume>((sc) => { if (DefaultHelper.IsDefault(local._client.SegmentVolume)) { return default(ESAPIX.Facade.API.SegmentVolume); } else { return new ESAPIX.Facade.API.SegmentVolume(local._client.SegmentVolume); } });
            }
            set
            {
