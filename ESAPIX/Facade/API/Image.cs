    ...
    public class Image : ESAPIX.Facade.API.ApiDataObject
    {
        ...
        public ESAPIX.Facade.Types.VVector UserOrigin
        {
            get
            {
                ...
                var local = this;
                return X.Instance.CurrentContext.GetValue<ESAPIX.Facade.Types.VVector>((sc) => { if (DefaultHelper.IsDefault(local._client.UserOrigin)) { return default(ESAPIX.Facade.Types.VVector); } else { return new ESAPIX.Facade.Types.VVector(local._client.UserOrigin); } });
            }
            set
            {
