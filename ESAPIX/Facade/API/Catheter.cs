    ...
    public class Catheter : ESAPIX.Facade.API.ApiDataObject
    {
        ...
        public ESAPIX.Facade.API.BrachyTreatmentUnit TreatmentUnit
        {
            get
            {
                ...
                var local = this;
                return X.Instance.CurrentContext.GetValue<ESAPIX.Facade.API.BrachyTreatmentUnit>((sc) => { if (DefaultHelper.IsDefault(local._client.TreatmentUnit)) { return default(ESAPIX.Facade.API.BrachyTreatmentUnit); } else { return new ESAPIX.Facade.API.BrachyTreatmentUnit(local._client.TreatmentUnit); } });
            }
            set
            {
