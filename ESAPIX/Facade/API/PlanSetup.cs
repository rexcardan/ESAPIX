    ...
    public class PlanSetup : ESAPIX.Facade.API.PlanningItem
    {
        ...
        public ESAPIX.Facade.API.Course Course
        {
            get
            {
                ...
                var local = this;
                return X.Instance.CurrentContext.GetValue<ESAPIX.Facade.API.Course>((sc) => { if (DefaultHelper.IsDefault(local._client.Course)) { return default(ESAPIX.Facade.API.Course); } else { return new ESAPIX.Facade.API.Course(local._client.Course); } });
            }
            set
            {
        ...
        public ESAPIX.Facade.API.OptimizationSetup OptimizationSetup
        {
            get
            {
                ...
                var local = this;
                return X.Instance.CurrentContext.GetValue<ESAPIX.Facade.API.OptimizationSetup>((sc) => { if (DefaultHelper.IsDefault(local._client.OptimizationSetup)) { return default(ESAPIX.Facade.API.OptimizationSetup); } else { return new ESAPIX.Facade.API.OptimizationSetup(local._client.OptimizationSetup); } });
            }
            set
            {
        ...
        public ESAPIX.Facade.Types.VVector PlanNormalizationPoint
        {
            get
            {
                ...
                var local = this;
                return X.Instance.CurrentContext.GetValue<ESAPIX.Facade.Types.VVector>((sc) => { if (DefaultHelper.IsDefault(local._client.PlanNormalizationPoint)) { return default(ESAPIX.Facade.Types.VVector); } else { return new ESAPIX.Facade.Types.VVector(local._client.PlanNormalizationPoint); } });
            }
            set
            {
        ...
        public ESAPIX.Facade.API.ReferencePoint PrimaryReferencePoint
        {
            get
            {
                ...
                var local = this;
                return X.Instance.CurrentContext.GetValue<ESAPIX.Facade.API.ReferencePoint>((sc) => { if (DefaultHelper.IsDefault(local._client.PrimaryReferencePoint)) { return default(ESAPIX.Facade.API.ReferencePoint); } else { return new ESAPIX.Facade.API.ReferencePoint(local._client.PrimaryReferencePoint); } });
            }
            set
            {
        ...
        public ESAPIX.Facade.API.Series Series
        {
            get
            {
                ...
                var local = this;
                return X.Instance.CurrentContext.GetValue<ESAPIX.Facade.API.Series>((sc) => { if (DefaultHelper.IsDefault(local._client.Series)) { return default(ESAPIX.Facade.API.Series); } else { return new ESAPIX.Facade.API.Series(local._client.Series); } });
            }
            set
            {
        ...
        public ESAPIX.Facade.API.StructureSet StructureSet
        {
            get
            {
                ...
                var local = this;
                return X.Instance.CurrentContext.GetValue<ESAPIX.Facade.API.StructureSet>((sc) => { if (DefaultHelper.IsDefault(local._client.StructureSet)) { return default(ESAPIX.Facade.API.StructureSet); } else { return new ESAPIX.Facade.API.StructureSet(local._client.StructureSet); } });
            }
            set
            {
        ...
        public ESAPIX.Facade.Types.DoseValue TotalPrescribedDose
        {
            get
            {
                ...
                var local = this;
                return X.Instance.CurrentContext.GetValue<ESAPIX.Facade.Types.DoseValue>((sc) => { if (DefaultHelper.IsDefault(local._client.TotalPrescribedDose)) { return default(ESAPIX.Facade.Types.DoseValue); } else { return new ESAPIX.Facade.Types.DoseValue(local._client.TotalPrescribedDose); } });
            }
            set
            {
        ...
        public ESAPIX.Facade.API.Fractionation UniqueFractionation
        {
            get
            {
                ...
                var local = this;
                return X.Instance.CurrentContext.GetValue<ESAPIX.Facade.API.Fractionation>((sc) => { if (DefaultHelper.IsDefault(local._client.UniqueFractionation)) { return default(ESAPIX.Facade.API.Fractionation); } else { return new ESAPIX.Facade.API.Fractionation(local._client.UniqueFractionation); } });
            }
            set
            {
        ...
        public ESAPIX.Facade.API.PlanSetup VerifiedPlan
        {
            get
            {
                ...
                var local = this;
                return X.Instance.CurrentContext.GetValue<ESAPIX.Facade.API.PlanSetup>((sc) => { if (DefaultHelper.IsDefault(local._client.VerifiedPlan)) { return default(ESAPIX.Facade.API.PlanSetup); } else { return new ESAPIX.Facade.API.PlanSetup(local._client.VerifiedPlan); } });
            }
            set
            {
