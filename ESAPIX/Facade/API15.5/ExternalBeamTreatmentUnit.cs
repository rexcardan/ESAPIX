...
namespace ESAPIX.Facade.API
{
    public class ExternalBeamTreatmentUnit : ESAPIX.Facade.API.ApiDataObject, System.Xml.Serialization.IXmlSerializable
    {
        ...
        public ESAPIX.Facade.API.TreatmentUnitOperatingLimits OperatingLimits
        {
            get
            {
                if ((_client) is System.Dynamic.ExpandoObject)
                {
                    if (((ExpandoObject)(_client)).HasProperty("OperatingLimits"))
                    {
                        return _client.OperatingLimits;
                    }
                    else
                    {
                        return default (ESAPIX.Facade.API.TreatmentUnitOperatingLimits);
                    }
                }
                else if ((XC.Instance) != (null))
                {
                    return XC.Instance.GetValue(sc =>
                    {
                        if ((_client.OperatingLimits) != (null))
                        {
                            return new ESAPIX.Facade.API.TreatmentUnitOperatingLimits(_client.OperatingLimits);
                        }
                        else
                        {
                            return null;
