    ...
    public class PlanSetup : ESAPIX.Facade.API.PlanningItem, System.Xml.Serialization.IXmlSerializable
    {
        ...
        public System.Double PlanNormalizationValue
        {
            ...
            set
            {
                ...
                if ((XC.Instance.CurrentContext) != (null))
                {
                    XC.Instance.CurrentContext.Thread.Invoke(() => _client.PlanNormalizationValue = (value));
                }
            }
        }
        ...
        public IEnumerable<System.String> PlanObjectiveStructures
        {
            get
            {
                if (_client is ExpandoObject)
        ...
        public IEnumerable<VMS.TPS.Common.Model.Types.ApprovalHistoryEntry> ApprovalHistory
        {
            get
            {
                if (_client is ExpandoObject)
                ...
                else
                {
                    ...
                    while (XC.Instance.CurrentContext.GetValue<bool>(sc => enumerator.MoveNext()))
                    {
                        ...
                        {
                            var vms = enumerator.Current;
                            facade = (VMS.TPS.Common.Model.Types.ApprovalHistoryEntry)vms;
                        }
        ...
        public ESAPIX.Facade.API.PlanSetup PredecessorPlan
        {
            get
            {
                if ((_client) is System.Dynamic.ExpandoObject)
                ...
                else if ((XC.Instance.CurrentContext) != (null))
                {
                    return XC.Instance.CurrentContext.GetValue(sc =>
                    {
                        ...
                        {
                            return new ESAPIX.Facade.API.PlanSetup(_client.PredecessorPlan);
                        }
                        else
                        {
                            return null;
        ...
        public IEnumerable<ESAPIX.Facade.API.ReferencePoint> ReferencePoints
        {
            get
            {
                if (_client is ExpandoObject)
                ...
                else
                {
                    ...
                    while (XC.Instance.CurrentContext.GetValue<bool>(sc => enumerator.MoveNext()))
                    {
                        var facade = new ESAPIX.Facade.API.ReferencePoint();
                        XC.Instance.CurrentContext.Thread.Invoke(() =>
                        {
                            var vms = enumerator.Current;
                            if (vms != null)
        ...
        public ESAPIX.Facade.API.RTPrescription RTPrescription
        {
            get
            {
                if ((_client) is System.Dynamic.ExpandoObject)
                ...
                else if ((XC.Instance.CurrentContext) != (null))
                {
                    return XC.Instance.CurrentContext.GetValue(sc =>
                    {
                        ...
                        {
                            return new ESAPIX.Facade.API.RTPrescription(_client.RTPrescription);
                        }
                        else
                        {
                            return null;
        ...
        public IEnumerable<ESAPIX.Facade.API.PlanTreatmentSession> TreatmentSessions
        {
            get
            {
                if (_client is ExpandoObject)
                {
                    if ((_client as ExpandoObject).HasProperty("TreatmentSessions"))
                    {
                        foreach (var item in _client.TreatmentSessions)
                        {
                            yield return item;
                        }
                    }
                ...
                else
                {
                    ...
                    XC.Instance.CurrentContext.Thread.Invoke(() =>
                    {
                        var asEnum = (IEnumerable)_client.TreatmentSessions;
                        if ((asEnum) != null)
                        {
                            enumerator = asEnum.GetEnumerator();
                        }
            ...
            {
                if (_client is ExpandoObject)
                    _client.TreatmentSessions = value;
            }
        }
        ...
        public System.Boolean UseGating
        {
            get
            {
                if ((_client) is System.Dynamic.ExpandoObject)
                {
                    if (((ExpandoObject)(_client)).HasProperty("UseGating"))
                    {
                        return _client.UseGating;
                    }
                    else
                    {
                        return default (System.Boolean);
            ...
            set
            {
                ...
                if ((XC.Instance.CurrentContext) != (null))
                {
                    XC.Instance.CurrentContext.Thread.Invoke(() => _client.UseGating = (value));
                }
            }
        }
        ...
        public void GetProtocolPrescriptionsAndMeasures(ref System.Collections.Generic.List<ESAPIX.Facade.API.ProtocolPhasePrescription> prescriptions, ref System.Collections.Generic.List<ESAPIX.Facade.API.ProtocolPhaseMeasure> measures)
        {
            if ((XC.Instance.CurrentContext) != (null))
            {
        ...
        public ESAPIX.Facade.API.ReferencePoint AddReferencePoint(ESAPIX.Facade.API.Structure structure, System.Nullable<VMS.TPS.Common.Model.Types.VVector> location, System.String id, System.String name)
        {
            if ((XC.Instance.CurrentContext) != (null))
            {
                var vmsResult = (XC.Instance.CurrentContext.GetValue(sc =>
                {
                    var fromClient = (_client.AddReferencePoint(structure._client, location, id, name));
                    if ((fromClient) == (null))
                    {
                        return null;
                    }

                    return new ESAPIX.Facade.API.ReferencePoint(fromClient);
                }
            ...
            {
                return (ESAPIX.Facade.API.ReferencePoint)(_client.AddReferencePoint(structure, location, id, name));
            }
        }
