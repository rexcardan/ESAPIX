...
namespace ESAPIX.Facade.API
{
    public class Structure : ESAPIX.Facade.API.ApiDataObject, System.Xml.Serialization.IXmlSerializable
    {
        ...
        public IEnumerable<VMS.TPS.Common.Model.Types.StructureApprovalHistoryEntry> ApprovalHistory
        {
            get
            {
                ...
                else
                {
                    ...
                    {
                        var facade = default (VMS.TPS.Common.Model.Types.StructureApprovalHistoryEntry);
                        XC.Instance.Invoke(() =>
                        {
                            var vms = enumerator.Current;
                            facade = (VMS.TPS.Common.Model.Types.StructureApprovalHistoryEntry)vms;
                        }
        ...
        public System.Boolean CanEditSegmentVolume(out System.String errorMessage)
        {
            if ((XC.Instance) != (null))
            {
                ...
                var vmsResult = (XC.Instance.GetValue(sc =>
                {
                    var fromClient = (_client.CanEditSegmentVolume(out errorMessage_OUT));
                    if (fromClient.Equals(default (System.Boolean)))
                    {
                        return default (System.Boolean);
                    }
            ...
            {
                return (System.Boolean)(_client.CanEditSegmentVolume(out errorMessage));
            }
        }
        ...
        public VMS.TPS.Common.Model.Types.VVector[] GetReferenceLinePoints()
        {
            if ((XC.Instance) != (null))
            {
                var vmsResult = (XC.Instance.GetValue(sc =>
                {
                    var fromClient = (_client.GetReferenceLinePoints());
                    if (fromClient.Equals(default (VMS.TPS.Common.Model.Types.VVector[])))
                    {
                        return default (VMS.TPS.Common.Model.Types.VVector[]);
                    }
            ...
            {
                return (VMS.TPS.Common.Model.Types.VVector[])(_client.GetReferenceLinePoints());
            }
        }
