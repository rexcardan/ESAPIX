...
namespace ESAPIX.Facade.API
{
    public class Image : ESAPIX.Facade.API.ApiDataObject, System.Xml.Serialization.IXmlSerializable
    {
        ...
        public IEnumerable<VMS.TPS.Common.Model.Types.ImageApprovalHistoryEntry> ApprovalHistory
        {
            get
            {
                ...
                else
                {
                    ...
                    {
                        var facade = default (VMS.TPS.Common.Model.Types.ImageApprovalHistoryEntry);
                        XC.Instance.CurrentContext.Thread.Invoke(() =>
                        {
                            var vms = enumerator.Current;
                            facade = (VMS.TPS.Common.Model.Types.ImageApprovalHistoryEntry)vms;
                        }
        ...
        public VMS.TPS.Common.Model.Types.VVector UserOrigin
        {
            ...
            set
            {
                ...
                if ((XC.Instance.CurrentContext) != (null))
                {
                    XC.Instance.CurrentContext.Thread.Invoke(() => _client.UserOrigin = (value));
                }
            }
        }
        ...
        public ESAPIX.Facade.API.StructureSet CreateNewStructureSet()
        {
            if ((XC.Instance.CurrentContext) != (null))
            {
                var vmsResult = (XC.Instance.CurrentContext.GetValue(sc =>
                {
                    var fromClient = (_client.CreateNewStructureSet());
                    if ((fromClient) == (null))
                    {
                        return null;
                    }
            ...
            {
                return (ESAPIX.Facade.API.StructureSet)(_client.CreateNewStructureSet());
            }
        }
