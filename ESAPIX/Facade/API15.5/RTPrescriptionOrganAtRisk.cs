...
{
    public class RTPrescriptionOrganAtRisk : ESAPIX.Facade.API.SerializableObject, System.Xml.Serialization.IXmlSerializable
    {
        ...
        public System.String OrganAtRiskId
        {
            get
            {
                if ((_client) is System.Dynamic.ExpandoObject)
                {
                    if (((ExpandoObject)(_client)).HasProperty("OrganAtRiskId"))
                    {
                        return _client.OrganAtRiskId;
                    }
                    else
                    {
        ...
        public RTPrescriptionOrganAtRisk(dynamic client)
        {
            _client = (client);
        }
    }
