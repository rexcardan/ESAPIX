...
{
    public class VolumeAtDoseConstraint : DoseStructureConstraint
    {
        ...
        /// </summary>
        [JsonIgnore]
        public virtual Func<double, bool> PassingFunc { get; set; }
        ...
        public override ConstraintResult Constrain(PlanningItem pi)
        {
            ...
            var val = $"{volAtDose.ToString("F2")} {stringUnit}";

            msg = $"Volume of {StructureName} at {ConstraintDose.Dose.ToString("F3")} {ConstraintDose.UnitAsString} was {val}.";
